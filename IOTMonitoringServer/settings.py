...
ALLOWED_HOSTS = ["localhost", "34.207.180.95","181.59.2.131"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "3.87.103.133",  # Dirección IP de la base de datos
