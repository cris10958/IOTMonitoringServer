...
ALLOWED_HOSTS = ["localhost", "54.226.192.240"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "54.196.104.217",  # Dirección IP de la base de datos
